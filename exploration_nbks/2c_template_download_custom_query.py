...
# Run this as : 
# python 2c_template_download_custom_query.py -A <.pkl> -C nonlinear -D <download_location>
...
if __name__=="__main__":
    ...
    query_2 = {'gyrokineticsIMAS.flux_surface.q':{"$gte": 2.0, "$lte": 2.1}}
    
    all_ids = [r['_id'] for r in collection_name.find(query_2,{'id':1})]
